...
/**
 * The database Panel for the GUI that holds all of the objects used inside the GUI, and deals with
...
public class DatabasePanel extends JPanel
{
	...
	/**
	 * The dumping place for all of the "baselayout.putConstraint" stuff that is generated by 
	 * the window builder.
	 */
	...
	/**
	 * setup the listeners so that the computer can respond to clicks and other inputs.
	 */
